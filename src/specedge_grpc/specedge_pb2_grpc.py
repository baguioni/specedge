...
class SpecEdgeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Done = channel.unary_unary(
                ...
                request_serializer=specedge__pb2.DoneRequest.SerializeToString,
                response_deserializer=specedge__pb2.DoneResponse.FromString,
                _registered_method=True)
...
def add_SpecEdgeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Done': grpc.unary_unary_rpc_method_handler(
                    servicer.Done,
                    request_deserializer=specedge__pb2.DoneRequest.FromString,
                    response_serializer=specedge__pb2.DoneResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'specedge.SpecEdgeService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('specedge.SpecEdgeService', rpc_method_handlers)
...
class SpecEdgeService(object):
    ...
    def Done(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/specedge.SpecEdgeService/Done',
            specedge__pb2.DoneRequest.SerializeToString,
            specedge__pb2.DoneResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
